...
Describe -tag 'PSSHL' -name 'StatisticsApi' {
    Context 'Get-GoalkeeperStatistics' {
        It 'Test Get-GoalkeeperStatistics' {
            #$TestResult = Get-GoalkeeperStatistics -Season "TEST_VALUE" -Sort "TEST_VALUE" -TeamIds "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-PlayersStatistics' {
        It 'Test Get-PlayersStatistics' {
            #$TestResult = Get-PlayersStatistics -Season "TEST_VALUE" -Sort "TEST_VALUE" -TeamIds "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-TeamsStandings' {
        It 'Test Get-TeamsStandings' {
            #$TestResult = Get-TeamsStandings -Season "TEST_VALUE" -TeamIds "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
