...
Describe -tag 'PSSHL' -name 'Live' {
    Context 'Live' {
        It 'Initialize-Live' {
            # a simple test to create an object
            #$NewObject = Initialize-Live -Gametime "TEST_VALUE" -TimePeriod "TEST_VALUE" -GameId "TEST_VALUE" -Period "TEST_VALUE" -Round "TEST_VALUE" -HomeTeamCode "TEST_VALUE" -HomeScore "TEST_VALUE" -AwayTeamCode "TEST_VALUE" -AwayScore "TEST_VALUE" -Venue "TEST_VALUE" -Attendance "TEST_VALUE" -StatusString "TEST_VALUE"
            #$NewObject | Should -BeOfType Live
