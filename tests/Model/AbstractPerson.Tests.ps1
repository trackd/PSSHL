...
Describe -tag 'PSSHL' -name 'AbstractPerson' {
    Context 'AbstractPerson' {
        It 'Initialize-AbstractPerson' {
            # a simple test to create an object
            #$NewObject = Initialize-AbstractPerson -FirstName "TEST_VALUE" -LastName "TEST_VALUE" -Nationality "TEST_VALUE" -ShortDescription "TEST_VALUE"
            #$NewObject | Should -BeOfType AbstractPerson
