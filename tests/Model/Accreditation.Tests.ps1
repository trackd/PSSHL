...
Describe -tag 'PSSHL' -name 'Accreditation' {
    Context 'Accreditation' {
        It 'Initialize-Accreditation' {
            # a simple test to create an object
            #$NewObject = Initialize-Accreditation -ContactInformation "TEST_VALUE"
            #$NewObject | Should -BeOfType Accreditation
