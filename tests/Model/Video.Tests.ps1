...
Describe -tag 'PSSHL' -name 'Video' {
    Context 'Video' {
        It 'Initialize-Video' {
            # a simple test to create an object
            #$NewObject = Initialize-Video -VideoId "TEST_VALUE" -Length "TEST_VALUE" -Name "TEST_VALUE" -TeamCode "TEST_VALUE" -ShortDescription "TEST_VALUE" -PublishDate "TEST_VALUE" -VideoPlaybackUrl "TEST_VALUE"
            #$NewObject | Should -BeOfType Video
