...
Describe -tag 'PSSHL' -name 'ArticleAuthor' {
    Context 'ArticleAuthor' {
        It 'Initialize-ArticleAuthor' {
            # a simple test to create an object
            #$NewObject = Initialize-ArticleAuthor -Title "TEST_VALUE" -Name "TEST_VALUE" -Email "TEST_VALUE"
            #$NewObject | Should -BeOfType ArticleAuthor
