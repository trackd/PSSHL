...
Describe -tag 'PSSHL' -name 'Staff' {
    Context 'Staff' {
        It 'Initialize-Staff' {
            # a simple test to create an object
            #$NewObject = Initialize-Staff -StaffId "TEST_VALUE" -Title "TEST_VALUE" -FirstName "TEST_VALUE" -LastName "TEST_VALUE" -Nationality "TEST_VALUE" -ShortDescription "TEST_VALUE"
            #$NewObject | Should -BeOfType Staff
