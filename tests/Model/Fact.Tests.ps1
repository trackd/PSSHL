...
Describe -tag 'PSSHL' -name 'Fact' {
    Context 'Fact' {
        It 'Initialize-Fact' {
            # a simple test to create an object
            #$NewObject = Initialize-Fact -Golds "TEST_VALUE" -Founded "TEST_VALUE" -Finals "TEST_VALUE" -Holy "TEST_VALUE" -Chairman "TEST_VALUE" -President "TEST_VALUE" -TeamCode "TEST_VALUE" -Fact "TEST_VALUE" -Contact "TEST_VALUE" -Accreditation "TEST_VALUE"
            #$NewObject | Should -BeOfType Fact
