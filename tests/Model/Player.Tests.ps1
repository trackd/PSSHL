...
Describe -tag 'PSSHL' -name 'Player' {
    Context 'Player' {
        It 'Initialize-Player' {
            # a simple test to create an object
            #$NewObject = Initialize-Player -PlayerId "TEST_VALUE" -DefaultJersey "TEST_VALUE" -ShootsRight "TEST_VALUE" -Shoots "TEST_VALUE" -Position "TEST_VALUE" -Captain "TEST_VALUE" -Assistant "TEST_VALUE" -Height "TEST_VALUE" -Weight "TEST_VALUE" -DateOfBirth "TEST_VALUE" -PlayerUrlDesktop "TEST_VALUE" -PlayerUrlMobile "TEST_VALUE" -FirstName "TEST_VALUE" -LastName "TEST_VALUE" -Nationality "TEST_VALUE" -ShortDescription "TEST_VALUE"
            #$NewObject | Should -BeOfType Player
