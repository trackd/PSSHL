...
Describe -tag 'PSSHL' -name 'PlayerStatisticsResponse' {
    Context 'PlayerStatisticsResponse' {
        It 'Initialize-PlayerStatisticsResponse' {
            # a simple test to create an object
            #$NewObject = Initialize-PlayerStatisticsResponse -PlayerStatistics "TEST_VALUE" -Metadata "TEST_VALUE"
            #$NewObject | Should -BeOfType PlayerStatisticsResponse
